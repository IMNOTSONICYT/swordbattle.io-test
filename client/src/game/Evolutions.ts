...
export const Evolutions: Record<any, [string, string, number, [number, number], string, string]> = {
  ...
  [EvolutionTypes.Candygrabber]: ['Candygrabber', 'candygrabberOverlay', 1.09, [0.5, 0.53], 'Collects 2x candy', 'Trick or Treat'],
  [EvolutionTypes.Spirit]: ['Spirit', 'spiritOverlay', 1.09, [0.5, 0.53], 'Phases through objects', 'No Knockback'],
  [EvolutionTypes.Werewolf]: ['Werewolf', 'werewolfOverlay', 1.09, [0.5, 0.53], 'More damage at low HP', 'Last Stand'],
  [EvolutionTypes.Mage]: ['Mage', 'mageOverlay', 1.09, [0.5, 0.53], 'Master of 7 elements', 'Conjure'],
  [EvolutionTypes.Alchemist]: ['Alchemist', 'alchemistOverlay', 1.09, [0.5, 0.53], 'Throws random potions', 'Quick Potions'],
  [EvolutionTypes.Necromancer]: ['Necromancer', 'necromancerOverlay', 1.09, [0.5, 0.53], 'Summons minions from kills', 'Minion Upgrade'],
  [EvolutionTypes.Astral]: ['Astral', 'astralOverlay', 1.09, [0.5, 0.53], 'Giant sword, stellar power', 'Stellar Evolution'],
};
